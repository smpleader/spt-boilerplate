...
<?php endif; ?>
<input name="<?php echo $this->field->name ?>" type="calendar" id="<?php echo $this->field->id ?>" <?php echo $this->field->required. ' '. $this->field->placeholder.' '. $this->field->autocomplete?>
