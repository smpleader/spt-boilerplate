...
<?php endif; ?>
<input name="<?php echo $this->field->name ?>" type="datetime-local" id="<?php echo $this->field->id ?>" <?php echo $this->field->required. ' '. $this->field->placeholder.' '. $this->field->autocomplete?>
